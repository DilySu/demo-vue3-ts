...
import chinaJson from "echarts";
import { getCurrentInstance, onMounted } from "vue";
const { proxy } = getCurrentInstance();

onMounted(() => {
  let myCharts = proxy.$echarts.init(document.getElementById("main"));
  proxy.$echarts.registerMap("china", chinaJson);
  ...
  const mapFeatures = proxy.$echarts.getMap(mapName).geoJson.features;
